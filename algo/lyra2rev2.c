...
void lyra2TDC_hash(void *state, const void *input)
{
...
int scanhash_lyra2TDC(int thr_id, struct work *work, uint32_t max_nonce, uint64_t *hashes_done)
{
